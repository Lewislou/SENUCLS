...
if __name__ == "__main__":
    ...
    dataset_name = "fs"
    save_root = "/mntnfs/med_data5/louwei/panuke/split231/%s/" % dataset_name

    # a dictionary to specify where the dataset path should be
    dataset_info = {
        "train": {
            "img": (".png", "/mntnfs/med_data5/louwei/panuke/Fold1/images/"),
            "ann": (".mat", "/mntnfs/med_data5/louwei/panuke/Fold1/Labels/"),
        },
        "valid": {
            "img": (".png", "/mntnfs/med_data5/louwei/panuke/Fold122/images/"),
            "ann": (".mat", "/mntnfs/med_data5/louwei/panuke/Fold122/labels/"),
        },
    }
